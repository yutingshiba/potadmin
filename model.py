...
def tp(y_true,y_pred):
    return kr.backend.sum(y_true*kr.backend.round(y_pred)/y_pred.int_shape[0])
def tn(y_true, y_pred):
    return kr.backend.sum((1-y_true) * (1-kr.backend.round(y_pred))/y_pred.int_shape[0])
def fp(y_true, y_pred):
    return kr.backend.sum(y_true * (1-kr.backend.round(y_pred))/y_pred.int_shape[0])
def fn(y_true, y_pred):
    return kr.backend.sum((1-y_true)*kr.backend.round(y_pred)/y_pred.int_shape[0])
